...
1. Install IRON library, mlir-aie and llvm-aie compilers from wheels and dependencies:
   ...
   python3 -m pip install https://github.com/Xilinx/llvm-aie/releases/download/nightly/llvm_aie-21.0.0.2026061501+acc2a72c-py3-none-manylinux_2_27_x86_64.manylinux_2_28_x86_64.whl
